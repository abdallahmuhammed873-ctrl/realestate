...
export function PendingListings({ items }: { items: PendingItem[] }) {
  if (items.length === 0) {
    return <p className="rounded-2xl border bg-white p-6">No pending listings.</p>;
  }
            ...
            <div className="grid gap-3 md:grid-cols-[220px,1fr]">
              ...
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-full bg-amber-100 px-2 py-1 text-xs font-semibold text-amber-700">Pending Review</span>

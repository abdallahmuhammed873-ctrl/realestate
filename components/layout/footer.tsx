...
function SocialIcon({
  ...
  if (isPlaceholder) {
    return (
      <span aria-label={label} title={`${label} (link coming soon)`} className={`${className} cursor-not-allowed opacity-60`}>
        {children}
      </span>
    );
  }
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            {appStoreComingSoon ? (
              ...
              >
                ...
                <span className="leading-tight">
                  <span className="block text-[11px] text-slate-200">Download on the</span>
            ...
            {googlePlayComingSoon ? (
              ...
              >
                ...
                <span className="leading-tight">
                  <span className="block text-[11px] text-slate-200">GET IT ON</span>

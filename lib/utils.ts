...
export function parseSearchParams(searchParams: Record<string, string | string[] | undefined>): SearchFilters {
  return {
    ...
    projectName: typeof searchParams.projectName === "string" ? searchParams.projectName : undefined,
    ...
    hasGarden: typeof searchParams.hasGarden === "string" ? searchParams.hasGarden === "true" : undefined,
    hasRoof: typeof searchParams.hasRoof === "string" ? searchParams.hasRoof === "true" : undefined,
    ...
    unitCode: typeof searchParams.unitCode === "string" ? searchParams.unitCode : undefined,
    inventoryStatus: typeof searchParams.inventoryStatus === "string" ? searchParams.inventoryStatus : undefined,
